...
#Table
closure.glm[[1]] %>% tidy(effect='fixed', conf.int=TRUE) %>% kable(caption = "Generalised linear mixed effects models of spawning activity of _P. maculatus_ captured by putative spawning closures on the Great Barrier Reef")
```
